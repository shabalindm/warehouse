...
class Model5 extends SimpleJoinModel {
	...
	Item[] getRowFromResultSet(int rowNumber) {
		...
		try {
			...
			row[2].pollFieldsFromResultSet(rs, "ID_ÇÀÏĞÎØ Â_ÃĞÓÏÏÀ Â_ÍÀÈÌÅÍÎÂÀÍÈÅ Â_ÒÓ Â_ÌÀĞÊÀ Â_ÅÄ_ÈÇÌÅĞÅÍÈß  Â_ÍÀ_ÑÊËÀÄÅ Â_ÊÎÌÏ_ÈÍÔÎ Â_ÄÀÒÀ_ÊÎÌÏ B_ÖÅÍÀ".split("\\s+"));
			row[1].pollFieldsFromResultSet(rs, "ID_ÇÀÏĞÎØ Ç_ÃĞÓÏÏÀ Ç_ÍÀÈÌÅÍÎÂÀÍÈÅ Ç_ÒÓ Ç_ÌÀĞÊÀ Ç_ÅÄ_ÈÇÌÅĞÅÍÈß  Ç_ÍÀ_ÑÊËÀÄÅ Ç_ÊÎÌÏ_ÈÍÔÎ Ç_ÄÀÒÀ_ÊÎÌÏ Ç_ÖÅÍÀ".split("\\s+"));
